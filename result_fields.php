  ...
  <body>
    <div style="background-color: rgb(241, 244, 244); min-height:500px; padding-bottom:50px">
      <div class="container">
        ...
        <p class="lead text-muted text-center" style="font-size: 15px">Post result</p>
        <hr>
        <br>

        <form class="mx-auto shadow" style="max-width:320px; border: 1px solid rgb(34, 139, 58); border-radius: 5px; padding:30px;" action="includes/result.input.inc.php" method="post">
            ...
            $check_result = mysqli_num_rows($result);
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                  if ($row['teacher_id'] == $_SESSION['user_id']) {
                    ...
                    echo "<option value=".$row['id'].">".$d_course." -  ".$d_dept."'".$d_series.", section ".$d_section."<hr></option>";
        ...
        -->
          ...
          <div class="form-group">
            ...
            <select class="form-control shadow" name="exam">
              <option value="none">-</option>
          ...
          <button type="submit" name="submit" class="shadow btn btn-block btn-success"><i class="fas fa-check" style="padding-right: 10px"></i>Select for Result</button>
        </form>
