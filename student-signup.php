...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title> RAM | Student Signup</title>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="container">
          ...
          <?php
              ...
              } elseif ( strpos($fullURL, "invalied-roll") ) {
                echo '<p class="lead text-center text-danger"><i class="fas fa-exclamation-triangle" style="padding-right: 10px"></i>Invalied student roll (roll must be a 7 digits number in correct form)</p>';
              ...
              elseif ( strpos($fullURL, "duplicate") ) {
                echo '<p class="lead text-center text-danger"><i class="fas fa-exclamation-triangle" style="padding-right: 10px"></i>This roll  has already been taken, Please use your roll!</p>';
              }
           ?> <br>

          <form style="max-width:400px" class="mx-auto container" action="includes/student.signup.inc.php" method="post">
            ...
            <div class="text-center">
              <text class="lead text-muted" style="font-size:15px"><i>
                <i class="fas fa-graduation-cap" style="padding-right: 5px"></i>
                You must be a current student of RUET
              </i></text><br><br>
            </div>
            ...
            <div class="input-group mb-3">
              ...
              <?php
                if (isset($_GET['roll'])) {
                  $roll = $_GET['roll'];
                  echo '<input type="number" class="form-control shadow" placeholder="Roll" name="roll" aria-label="Username" aria-describedby="basic-addon1">';
                }else {
                  echo '<input type="number" class="form-control shadow" placeholder="Roll" name="roll" aria-label="Username" aria-describedby="basic-addon1">';
                };
               ?>
            ...
            <div class="input-group mb-3">
              ...
              <?php
                if (isset($_GET['phone'])) {
                  $phone = $_GET['phone'];
                  echo '<input type="number" class="form-control shadow" placeholder="Phone Number" name="phone" aria-label="Username" aria-describedby="basic-addon1">';
                }else {
            ...
            <div class="input-group">
              ...
              <?php
                if (isset($_GET['email'])) {
                  $email = $_GET['email'];
                  echo '<input type="email" class="form-control shadow" placeholder="E-mail" name="email" aria-label="Username" aria-describedby="basic-addon1">';
                }else {
