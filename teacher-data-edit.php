      ...
      <div class="container">
        ...
        <div class="container">
          ...
          <div class="text-center">
            <input type="text" name="user-old-pass" placeholder="Enter your password to ensure" style="width: 400px; height: 30px; border-radius: 5px; border: 1px solid rgb(17, 159, 62);" class="text-center mx-auto">
            <br><br>
