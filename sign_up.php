  ...
  <body>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="container">
          ...
          <form style="max-width:400px" class="mx-auto container" action="includes/sign.up.inc.php" method="post">
            ...
            <small class="form-text text-muted mb-3">i.e. professor/lecturer/student etc.</small>
            <div class="input-group">
              <div class="input-group-prepend shadow">
              ...
              <?php
                if (isset($_GET['code'])) {
                  $code = $_GET['code'];
                  echo '<input type="number" class="form-control shadow" placeholder="Code/Roll" name="code" aria-label="Username" aria-describedby="basic-addon1" value='.$code.'>';
                }else {
                  echo '<input type="number" class="form-control shadow" placeholder="Code/Roll" name="code" aria-label="Username" aria-describedby="basic-addon1">';
                };
               ?>
              <small class="form-text text-info">*to register as teacher, enter the code provided to you</small>
              <small class="form-text text-info mb-3">*to register as student, enter your roll</small>
            </div>
          ...
          <?php
              ...
              if ( strpos($fullURL, "empty") ) {
                echo '<p class="lead text-center text-danger">Fill all fields</p>';
              } elseif ( strpos($fullURL, "not_matched") ) {
                echo '<p class="lead text-center text-danger">Password did not matched</p>';
              } elseif ( strpos($fullURL, "teacher_code") ) {
                echo '<p class="lead text-center text-danger">Teacher code did not matched<br>Or, check your designation.</p>';
              } elseif ( strpos($fullURL, "roll_invalied") ) {
                echo '<p class="lead text-center text-danger">Invalied student roll</p>';
              }
           ?>
